...
for(let i = 0; i < array.length; i++){
    console.log(array[i].jobTitle)
    console.log(...array[i].locations)
    console.log(array[i].jobSalary)
    array[i].benefits.forEach((v)=>{
        console.log(`${v.benefitIconName}, ${v.benefitName},${v.benefitValue}`)
    })
    array[i].skills.forEach((v,i) => {console.log(`${i+1} ${v}`)})
    console.log(array[i].jobRequirement)
    console.log('-----------------------------------------------------------')
}